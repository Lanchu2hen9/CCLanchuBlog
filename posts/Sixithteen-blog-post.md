...
1. Domain (shared area of interest or focus) - Is the problem, that the group is trying to solve.
2. Repertoire (shared tools, language, practices, resources) - the behaviours, the actions, the values.
